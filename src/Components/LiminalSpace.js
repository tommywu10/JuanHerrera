...
import liminal from "../images/liminal-crew.jpg"
...
export default function LiminalSpace(){
    return (
        <div className="liminal-space-container">
            ...
            <div className="liminal-space-content">
                ...
                <br></br>
                <br></br>
                Based in Buffalo, NY, Liminal Space Ensemble was founded in August 2019 by Nicole Murray (flute) and Hope Wilk (harp) and features a core artist lineup of the top chamber musicians in the area. When not performing with LSE, members can be found performing with the Buffalo Philharmonic Orchestra, Buffalo Chamber Players, and several other prestigious ensembles. LSE’s musicians represent the top music conservatories in the world including Curtis, Juilliard, Peabody, Manhattan School of Music, San Francisco Conservatory of Music, New England Conservatory, and the Glenn Gould School of Music at the Royal Conservatory.</p>

                <img id="liminal-crew-img" src={liminal} alt="Liminal crew"/>
            </div>
